# Showdown: Q4_K_XL vs cdiamond NVFP4

_Generated 2026-09-25T09:13:18Z — weights: correctness 0.45, token_cost 0.25, latency 0.2, longctx 0.1_

## Verdict: **cdiamond NVFP4**

Class wins: Q4_K_XL 0 — 1 cdiamond NVFP4

| | Q4_K_XL | cdiamond NVFP4 |
|---|---|---|
| served model | `/home/joshua/llama.cpp/models/Qwen3.8-27B-UD-Q4_K_XL-GGUF/Qwen3.8-27B-UD-Q4_K_XL.gguf` | `/home/joshua/.cache/huggingface/hub/models--cdiamond--Qwen3.8-27B-iMatrix-NVFP4-MTP-GGUF/snapshots/ac343e8f44caef0896f79d372ecc07ef7ab34ec8/Qwen3.8-27B-iMatrix-NVFP4-MTP.gguf` |
| pass rate | 92.7% (38/41) | 95.1% (39/41) |
| median wall per call | 3.79s | 3.01s |
| p90 wall | 10.23s | 11.0s |
| max wall | 12.76s | 16.42s |
| median tokens / call | 432 | 398 |
| median reasoning tokens / call | 0 | 0 |
| **tokens per CORRECT answer** | **406** | **380** |
| **seconds per CORRECT answer** | **3.51** | **2.87** |
| weighted score | 0.9343 | 0.9559 |

## By class

| class | Q4_K_XL | cdiamond NVFP4 | winner |
|---|---|---|---|
| arithmetic | 6/6 (100%) | 6/6 (100%) | tie |
| codegen | 6/6 (100%) | 6/6 (100%) | tie |
| doctrine | 6/6 (100%) | 6/6 (100%) | tie |
| extraction | 3/6 (50%) | 4/6 (67%) | cdiamond NVFP4 |
...
- Raw replies: `runs/raw_qwen38-27b-q4kxl.jsonl` and `runs/raw_qwen38-27b-nvfp4-imatrix.jsonl` — re-grade from these before believing any single row.
